 ...
 * The manifest is a .vvx file, structured as follows:
 * Video File
     ...
     */
     public void setVideo(String videoName) throws FileNotFoundException {
         try {
             ...
             //Add new video to top of the temporary file
             ...
             new WarningDialogue("This project already contains a temporary file, not generated by Vidivox. (Called Temp.vvx)\nPlease remove it, then try again.");
         }
     }
